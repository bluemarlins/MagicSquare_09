class TestDomainConstantsRed:
    def test_magic_constant_grid_size_blank_count_constants(self) -> None:
        ...
        magic_constant = load_attr("src.entity.constants", "MAGIC_CONSTANT")
        grid_size = load_attr("src.entity.constants", "GRID_SIZE")
        blank_count = load_attr("src.entity.constants", "BLANK_COUNT")
